...
[中文](literal-i18n.md) | [English](literal-i18n.en.md)  |  [GitHub](https://github.com/gguser1995-spec/literal-i18n) | [Gitee](https://gitee.com/lwfux/literal-i18n)
...
`--watch` 适合你没有使用 Next 插件，或主动设置了 `devWatch: false` 并希望用 CLI 自己接管开发态抽取的场景。默认情况下，Next.js 15 dev 由 webpack watch 抽取，Next.js 16 / Turbopack dev 由 `withLiteralI18n` 的内置 watcher 抽取。
...
- 未设置：Next.js 15 默认走 webpack watch；Next.js 16 默认走内置 watcher。
...
⚠️ **请先提 Issue，暂不接受直接提交的 Pull Request。**
